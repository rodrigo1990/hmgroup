...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','351','height','343','src','swf/destacado','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','swf/destacado','wmode','transparent','FlashVars','cantidad=<? echo $cantImg; ?>&ArrayNombres=<? echo $arrayImgs; ?>&titulo=<? echo urlencode($producto_destacado['titulo']); ?>&texto=<? echo urlencode($producto_destacado['descripcion']); ?>&link=producto.php?id_producto=<? echo $producto_destacado['id_producto'];?>' ); //end AC code
          ...
          <param name="quality" value="high">
          <param name="wmode" value="transparent">
          <param name="FlashVars" value="cantidad=<? echo $cantImg; ?>&ArrayNombres=<? echo $arrayImgs; ?>&titulo=<? echo urlencode($producto_destacado['titulo']); ?>&texto=<? echo urlencode($producto_destacado['descripcion']); ?>&link=producto.php?id_producto=<? echo $producto_destacado['id_producto'];?>">
          <embed src="swf/destacado.swf" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="351" height="343"></embed>
        </object></noscript>
        <? } ?>
        ...
        <td rowspan="2" valign="top" bgcolor="#DADADA"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="404">
              ...
              <tr>
                <td colspan="3" valign="top" background="img/ventana_destacado_r2_c1.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td height="20" valign="top" class="titulos_promociones">
                      <? PF::html($prod['titulo']); ?>
                   </td>
                  </tr>
                  <tr>
              ...
              <tr>
                <td><img name="ventana_destacado_r3_c1" src="img/ventana_destacado_r3_c1.jpg" width="18" height="18" border="0" id="ventana_destacado_r3_c1" alt="" /></td>
                <td><img name="ventana_destacado_r3_c2" src="img/ventana_destacado_r3_c2.jpg" width="368" height="18" border="0" id="ventana_destacado_r3_c2" alt="" /></td>
                <td><img name="ventana_destacado_r3_c3" src="img/ventana_destacado_r3_c3.jpg" width="18" height="18" border="0" id="ventana_destacado_r3_c3" alt="" /></td>
                </tr>
            </table>
        ...
        <td colspan="3" rowspan="2" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="335">
              ...
              <tr>
                <td><img name="ventana_promo_r1_c1" src="img/ventana_promo_r1_c1.jpg" width="17" height="134" border="0" id="ventana_promo_r1_c1" alt="" /></td>
                <td valign="middle" background="img/ventana_promo_r1_c2.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td height="25" class="titulos_destacados"><? PF::html($prod['titulo']); ?></td>
                  </tr>
                  
                  <tr>
                    <td height="50" class="texto_destacados"><? echo $prod['descripcion']; ?></td>
                  </tr>
                  <tr>
                ...
                <td><img name="ventana_promo_r1_c3" src="img/ventana_promo_r1_c3.jpg" width="18" height="134" border="0" id="ventana_promo_r1_c3" alt="" /></td>
