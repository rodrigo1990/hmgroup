...
class recuadro{
	 ...
	 *
	*/
	function recuadro($AltoOrigen,$AnchoOrigen,$AltoMarco,$AnchoMarco,$modo){
...
class Tijera{
	...
	function recortar(){
		...
		$descarte="temporal".$datos_imagen['extension'];
		if (copy ($this->origen, $descarte)){
			...
			elseif($this->modo=="EscalaTotal"){
				...
				$anchoFinal=$this->anchoCopia;
				$altoFinal=$this->altoCopia;
				$solucion=new recuadro($this->altoOrig,$this->anchoOrig,$this->altoCopia,$this->anchoCopia,"EscalaTotal");
			...
			elseif($this->modo=="EscalaModificada"){
				...
				$anchoFinal=$this->anchoCopia;
				$altoFinal=$this->altoCopia;
				$solucion=new recuadro($this->altoOrig,$this->anchoOrig,$this->altoCopia,$this->anchoCopia,"EscalaModificada");
				$aSol=$solucion->calcular();
				//print_r($aSol);
				$this->cordXCopia=$aSol['posicionMarco_Xo'];
				$this->cordYCopia=$aSol['posicionMarco_Yo'];
