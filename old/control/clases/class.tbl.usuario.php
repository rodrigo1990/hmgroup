...
FROM ".$this->tabla." ";
	...
	function nuevo($arrayData,$arrayPerfil){
		$arrayData['provincia']='';
		$arrayData['pais']='';
		$arrayData['cp']='';
		$arrayData['empresa']='';
	...
	function actualizar($arrayData,$arrayPerfil){
		$arrayData['provincia']='';
		$arrayData['pais']='';
		$arrayData['cp']='';
		$arrayData['empresa']='';
		...
		$arrayData['direccion']='';
		$oUsu=new Usuario($this->oDBM);
		$ok=$oUsu->actualizarUsuario($arrayData,$arrayPerfil);
	...
	function eliminar($id_usuario){
		...
		return $oUsu->eliminarUsuario($id_usuario);
	}
