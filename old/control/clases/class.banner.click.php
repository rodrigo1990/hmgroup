<?php
class Banner_Click extends PFTableManager {
	 ...
	 * @return Click
	 */
	function Banner_Click($oDBM){
		$this->pref='banner_';
		$this->tabla=$this->pref.'click';
		$this->oDBM=$oDBM;
		$this->aErrors=array();
...
FROM ".$this->tabla." ";
	...
	function eliminarClicksBanner($idBanner){
	...
	/*
	function getEstadisticas($idBanner,$fechaInicio=NULL,$fechaFin=NULL){
		$sql="SELECT 
		fecha,
		cantidad
		FROM ".$this->tabla."
