...
<table class="tabla" width="600" border="0" cellspacing="0" cellpadding="3" style="margin-left:20px;" id="set">
  ...
  <tr>
	...
	<td width="150" align="center" valign="middle" class="menu_categorias"><? if($this->ListaMayorista==NULL){ ?>
																					<a href="<? echo $this->modulo; ?>?<? $this->encodeURL('accion=nuevo&variable=LISTAMAYORISTA'); ?>">Nueva Lista</a>
																			<? }else{ ?>
																					Nueva Lista
																			<? } ?>
																					</td>
	<td width="100" align="center" valign="middle" class="menu_categorias"><? if($this->ListaMayorista!=NULL){ ?>
																					<a href="<? echo $this->modulo; ?>?<? $this->encodeURL('accion=verContenido&archivo='.RUTA_CONTENIDO.'/'.$this->ListaMayorista); ?>">Ver Lista</a></td>
																			<? }else{ ?>
																					Ver Lista
																			<? } ?>
    <td width="100" align="center" valign="middle" class="menu_categorias"><? if($this->ListaMayorista!=NULL){ ?>
  ...
  <tr>
	...
	<td width="150" align="center" valign="middle" class="menu_categorias"><? if($this->ListaDistribuidor==NULL){ ?>
																					<a href="<? echo $this->modulo; ?>?<? $this->encodeURL('accion=nuevo&variable=LISTADISTRIBUIDOR'); ?>">Nueva Lista</a></td>
																			<? }else{ ?>
																					Nueva Lista
																			<? } ?>
	<td width="100" align="center" valign="middle" class="menu_categorias"><? if($this->ListaDistribuidor!=NULL){ ?>
																					<a href="<? echo $this->modulo; ?>?<? $this->encodeURL('accion=verContenido&archivo='.RUTA_CONTENIDO.'/'.$this->ListaDistribuidor); ?>">Ver Lista</a></td>
																			<? }else{ ?>
																					Ver Lista
																			<? } ?>
    <td width="100" align="center" valign="middle" class="menu_categorias"><? if($this->ListaDistribuidor!=NULL){ ?>
