  ...
  <tr class="encabezadoTabla">
    <td width="424" >
        <form id="formBuscar" name="formBuscar" method="post" action="<? echo $this->modulo; ?>">
    		...
    		<span class="tituloListado"><? echo($this->tipo==2)?"Administradores":"Usuarios Registrados"; ?></span>
    	</form>
	</td>
    <td colspan="2" align="center" >
    	<a href="<? echo $this->modulo; ?>?<?  $this->encodeURL('accion=nuevo'); ?>" class="tituloListado"><? echo($this->tipo==2)?"Nuevo Administrador":"Nuevo Usuario Registrado"; ?></a>
    </td>
  </tr>
  	...
  	<input type="hidden" name="form" id="form"  value="formUsuario"/>
		<div class="divDataForm">
			<div class="textoTituloForm">
				<? echo ($this->edicion)? 'Editando':'Nuevo'; ?> <? echo($this->tipo==2)?"Administrador:":"Usuario Registrado:"; ?>
			</div>
