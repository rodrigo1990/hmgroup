...
<table width="98%" border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				?>
                <div class="listaCat" >
                <a href="#" id="c<? echo $idCat; ?>" <? echo (count($arraySubCats[$idCat])>0)? 'onmouseover="menu_show(\'sc'.$idCat.'\',\'lc\');" onmouseout="leave_link();"':''; ?>><img src="img/vineta.jpg" width="7" height="7" border="0"> <? PF::html($categoria['descripcion']); ?></a>                
               </div>
               <? } ?>
