  ...
  <tr>
    <td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="995">
      ...
      <tr>
        ...
        <td rowspan="3" colspan="2"><img name="layout_productos_r1_c2" src="img/borrar_r1_c2.jpg" width="182" height="104" border="0" id="layout_productos_r1_c2" alt="" /></td>
        <td colspan="5">&nbsp;</td>
                    ...
                    <td valign="top" background="img/producto_item_r1_c2.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
						...
						if($enPromocion){ 
                        	...
                        	echo $prod['descripcion_abreviada']; 
						} 
                       ?>
                        </span></td>
                      </tr>
