...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','351','height','343','src','swf/destacado','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','swf/destacado','wmode','transparent','FlashVars','cantidad=<? echo $cantImg; ?>&ArrayNombres=<? echo $arrayImgs; ?>&ArrayURL=<? echo $arrayImgsURL; ?>&titulo=<? echo urlencode($producto_destacado['titulo']); ?>&texto=<? echo urlencode($producto_destacado['descripcion']); ?>&link=producto.php?id_producto=<? echo $producto_destacado['id_producto'];?>' ); //end AC code
          ...
          <param name="quality" value="high">
          <param name="wmode" value="transparent">
          <param name="FlashVars" value="cantidad=<? echo $cantImg; ?>&ArrayNombres=<? echo $arrayImgs; ?>&ArrayURL=<? echo $arrayImgsURL; ?>&titulo=<? echo urlencode($producto_destacado['titulo']); ?>&texto=<? echo urlencode($producto_destacado['descripcion']); ?>&link=producto.php?id_producto=<? echo $producto_destacado['id_producto'];?>">
          <embed src="swf/destacado.swf" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="351" height="343" flashvars="cantidad=<? echo $cantImg; ?>&ArrayNombres=<? echo $arrayImgs; ?>&ArrayURL=<? echo $arrayImgsURL; ?>&titulo=<? echo urlencode($producto_destacado['titulo']); ?>&texto=<? echo urlencode($producto_destacado['descripcion']); ?>&link=producto.php?id_producto=<? echo $producto_destacado['id_producto'];?>"></embed>
        </object></noscript>
        <? } ?>
