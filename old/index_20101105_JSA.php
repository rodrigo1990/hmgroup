...
$productos_promocion=$oEx->getProductosEnPromocion(0,5);
			...
			?>
                      <tr>
                        <td colspan="3" valign="top" background="img/ventana_destacado_r2_c1.jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="10" valign="top" class="titulos_noticias"><div style="margin:10 20"><? PF::html($prod['titulo']); ?></div></td>
                            </tr>
                          <tr>
                            <td height="5" align="center" valign="top"><span style="margin:20 20"><img src="img/borrar_r1_c4.jpg" width="364" height="1" border="0" alt="" /></span></td>
                            </tr>
                          <tr>
