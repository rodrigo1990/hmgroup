...
<table width="98%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <a href="#" id="c<? echo $idCat; ?>" <? echo (count($arraySubCats[$idCat])>0)? 'onmouseover="menu_show(\'sc'.$idCat.'\',\'ll'.$idCat.'\');" onmouseout="leave_link();"':''; ?>><img src="img/vineta.jpg" width="7" height="7" border="0"> <? PF::html($categoria['descripcion']); ?></a>                
               </div>
               <? } ?>
