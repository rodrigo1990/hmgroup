<section role="main" class="content-body">
	<header class="page-header">
		<h2>Nosotros - Editar Contenido</h2>
	</header>
	...
	<div class="row">
		<div class="col-md-12">
		    ...
		    {
		        ?>
		        <div style="background:#02600F; color: #ffffff; text-align: center; font-size: 13px; padding: 4px 0px;">Se ha editado el contenido correctamente. Refesque la p&aacute;gina para ver los cambios o haga <a href="?s=nosotros_contenido">click aquí</a>.</div>
		        <?php
		    }
		    ?>
		    <?php	
				$consulta = "SELECT id, titulo1, descripcion1, foto1, titulo2, descripcion2, foto2 FROM nosotros_contenido";
				$resultado = mysql_query($consulta);
				$fila = mysql_fetch_array($resultado);
				
		        include('includes/acentos_nosotros.php');
			?>
				...
				<section class="panel">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<img src="nosotros/<?php echo($fila['foto1']); ?>" alt="" style="width: 160px;" /><br /><br />
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<img src="nosotros/<?php echo($fila['foto2']); ?>" alt="" style="width: 160px;" /><br /><br />
			...
			<?php
				if($_POST['submit'])
				{
					...
					$idproducto = $_GET['g']; 
					$query = "UPDATE nosotros_contenido SET titulo1='$titulo1', descripcion1='$descripcion1', foto1='$foto1_bd', titulo2='$titulo2', descripcion2='$descripcion2', foto2='$foto2_bd'";
					mysql_query($query);
					mysql_close();
				}
