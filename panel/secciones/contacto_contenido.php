<section role="main" class="content-body">
	...
	<div class="row">
		<div class="col-md-12">
		    ...
		    {
		        ?>
		        <div style="background:#02600F; color: #ffffff; text-align: center; font-size: 13px; padding: 4px 0px;">Se ha editado el contenido correctamente. Refesque la p&aacute;gina para ver los cambios o haga <a href="?s=contacto_contenido">click aquí</a>.</div>
		        <?php
		    }
		    ?>
		    <?php	
			...
			?>
			<form id="form" action="?s=contacto_contenido&alert=si" method="post" enctype="multipart/form-data" class="form-horizontal">
				<section class="panel">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								Ingresar únicamente el SRC del iframe de Google.
							</div>
						</div>
						<div class="form-group">
