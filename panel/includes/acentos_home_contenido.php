<?php
	...
	$titulo_boton = utf8_encode($fila['titulo_boton']);
        $titulo_boton = html_entity_decode($titulo_boton);
        $titulo_boton = str_replace("Ã¡", "á",$titulo_boton);
        $titulo_boton = str_replace("Ã©", "é",$titulo_boton);
        $titulo_boton = str_replace("Ã*", "í",$titulo_boton);
        $titulo_boton = str_replace("Ã³", "ó",$titulo_boton);
        $titulo_boton = str_replace("Ãº", "ú",$titulo_boton);
        $titulo_boton = str_replace("Ã", "Á",$titulo_boton);
        $titulo_boton = str_replace("Ã‰", "É",$titulo_boton);
        $titulo_boton = str_replace("Ã", "Í",$titulo_boton);
        $titulo_boton = str_replace("Ã“", "Ó",$titulo_boton);
        $titulo_boton = str_replace("Ãš", "Ú",$titulo_boton);
        $titulo_boton = str_replace("Ã±", "ñ",$titulo_boton);
        $titulo_boton = str_replace("Ã‘", "Ñ",$titulo_boton);
        $titulo_boton = str_replace("Â¿", "¿",$titulo_boton);
        $titulo_boton = str_replace("Â«", "'",$titulo_boton);
        $titulo_boton = str_replace("Â»", "'",$titulo_boton);
        $titulo_boton = str_replace("Â¡", "¡",$titulo_boton);
?>